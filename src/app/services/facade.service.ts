...
const session_cookie_name = 'tecnologias-web-token';
const user_email_cookie_name = 'tecnologias-web-email';
const user_id_cookie_name = 'tecnologias-web-user_id';
const user_complete_name_cookie_name = 'tecnologias-web-user_complete_name';
const group_name_cookie_name = 'tecnologias-web-group_name';
const codigo_cookie_name = 'tecnologias-web-codigo';
